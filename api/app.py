...
if __name__ == '__main__':
    ...
    if load_models():
        ...
        print("  • Predict:        http://localhost:8080/api/predict")
        print("  • Batch Predict:  http://localhost:8080/api/predict/batch")
        print("  • Health Check:   http://localhost:8080/api/health")
        print("  • Model Info:     http://localhost:8080/api/model/info")
        print("  • Documentation:  http://localhost:8080/api/docs")
        print("\n" + "="*70)
        
        # Run Flask app on port 8080 (Node.js backend uses 5000)
